...
- `strategyMetadata`: trigger name, elapsed second/minute, edge scale/min required edge, market start timing, Pyth candle/market start delta and tolerance, partial return bps, close location, fair threshold, max acceptable ask, ask price, edge
